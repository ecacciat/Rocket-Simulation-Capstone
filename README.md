...
fuel burn rate. The rocket's drag is calculated using the following equation with air density (rho), current 
...
validation scripts from using illogical outputs. 
  ...
  C++ was specifically used for its high performance mathematical integration, while Python 
